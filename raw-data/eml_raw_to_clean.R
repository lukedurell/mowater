...
setwd("/Users/lukedurell/Box Sync/education/research/mowater data upload/eml_raw")
...
save(eml, file = "/Users/lukedurell/Box Sync/education/research/mowater data upload/eml/eml.RData")
